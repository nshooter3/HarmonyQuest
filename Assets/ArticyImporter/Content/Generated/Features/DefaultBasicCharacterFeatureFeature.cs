...
namespace Articy.Harmonybarktest.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Harmonybarktest.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Harmonybarktest.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.Harmonybarktest.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Harmonybarktest.Features.DefaultBasicCharacterFeatureFeature();
